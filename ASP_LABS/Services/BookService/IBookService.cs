...
namespace ASP_LABS.Services.BookService
{
    public interface IBookService
    {
        ...
        /// </summary>
        /// <param name="bookNormalizedName">нормализованное имя категории для фильтрации</param>
        /// <param name="pageNo">номер страницы списка</param>
        /// <returns></returns>
        public Task<ResponseData<ListModel<Book>>> GetBookListAsync(string? bookNormalizedName, int pageNo = 1);
        /// <summary>
        /// Поиск объекта по Id
        /// </summary>
